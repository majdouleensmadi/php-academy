...
if (isset($_POST["submit"])) {
  ...
  $sql = "UPDATE `employee` SET `img`='$img',`name`='$name',`address`='$address' WHERE  id = $id";

  $result = mysqli_query($conn, $sql);

  if ($result) {
    header("Location: LandingPage.php?msg=Data updated successfully");
  } else {
    ...
    <div class="container d-flex justify-content-center">
      <form action="" method="post" style="width:50vw; min-width:300px;">
        ...
        <div>
          ...
          <a href="LandingPage.php" class="btn btn-danger">Cancel</a>
        </div>
      </form>
    </div>
  </div>
