...
$product_name = $product_code = $product_price = $product_image = $product_qty = "";
$product_name_err = $product_code_err = $product_price_err = $product_image_err = $contact_qty_err = "";
...
if (empty($input_product_qty)) {
    ...
    // if (empty($name_err) && empty($avatar_err) && empty($email_err) && empty($address_err)) {
        ...
        if ($stmt = $mysqli->prepare($sql)) {
            ...
            $stmt->bind_param("sssss", $param_product_name, $param_product_code, $param_product_price, $param_product_image, $param_product_qty);
